...
class GeneticAlgoritm:
    ...
    def inicial_value(self):
        ...
        while not can:
            ...
            if batteryIsValid(matrix):
                can=1
        return random_arr

    def batteryIsValid(self,matrix):
        ...
        while not is_valid:
            ...
            for drone in range(matrix1):
                ...
                while random_val1==random_val2:
                    ...
                    new_matrix.append(matrix1[drone][:random_val1]+matrix2[drone][random_val1:random_val2]+matrix1[drone][random_val2:])
