...
function varargout = tsp_ga(varargin)
    ...
    % Initialize default configuration
     coorX=[82 91 12 92 63];    
     coorY=[66 3 85 94 68];
%     
%    coorX=[82 91 12 92 63 9 28 55 96 97 15 98 96 49 80 14 42 92 80 96];
%    coorY=[66 3 85 94 68 76 75 39 66 17 71 3 27 4 9 83 70 32 95 3];    
    
    defaultConfig.xy(:,1)=coorX;
    defaultConfig.xy(:,2)=coorY;
